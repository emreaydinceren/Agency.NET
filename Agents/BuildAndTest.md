...
# Run functional tests manually (proxy at localhost:12345 must be running)
...
- Functional tests require the HTTP cache proxy running at `http://localhost:12345` (from the Agency.HttpCacheProxy repo) and LM Studio at `http://llm-host.example:1234`.
