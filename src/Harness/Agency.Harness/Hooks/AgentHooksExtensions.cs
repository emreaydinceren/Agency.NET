...
public static class AgentHooksExtensions
{
    ...
    /// to see the un-enriched <see cref="Agency.Harness.Contexts.Context"/> before the baseline hooks
    ...
    private static Func<IReadOnlyList<ToolInvokedEvent>, Agency.Harness.Contexts.Context, CancellationToken, Task>?
        CombinePostToolBatch(
            Func<IReadOnlyList<ToolInvokedEvent>, Agency.Harness.Contexts.Context, CancellationToken, Task>? a,
            Func<IReadOnlyList<ToolInvokedEvent>, Agency.Harness.Contexts.Context, CancellationToken, Task>? b) =>
        (a, b) switch
        {
            (null, null) => null,
            (not null, null) => a,
